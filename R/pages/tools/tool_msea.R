...
tools_msea_server <- function(input, output, session, app_state, rv, defs_msea) {
  ...
  observeEvent(input$tools_msea_reset, {
    ...
    updateNumericInput(session, "tools_msea_max_terms", value = defs_msea$style$max_terms %||% 20)
  ...
  observeEvent(input$tools_msea_run, {
    ...
    style <- list(
      max_terms = safe_int(input$tools_msea_max_terms, defs_msea$style$max_terms %||% 20),
  ...
  output$tools_msea_tabs <- renderUI({
    ...
    tagList(
      ...
      div(
        ...
        actionButton("tools_msea_rerender", "Re-render", class = "btn btn-sm btn-default", icon = icon("arrows-rotate"),
  ...
  observeEvent(input$tools_msea_rerender, {
